...
### Run with pytest
```bash
pytest tests/test_update_installer_comprehensive.py -v
pytest tests/test_update_installer_ui_integration.py -v
pytest tests/test_update_installer_scripts.py -v
```
