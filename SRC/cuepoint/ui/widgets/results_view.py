...
class ResultsView(QWidget):
    ...
    def __init__(
        self,
        results_controller: Optional[ResultsController] = None,
        export_controller: Optional[ExportController] = None,
        parent: Optional[QWidget] = None,
    ) -> None:
        super().__init__(parent)
        # Use provided controllers or create new ones
        self.results_controller = results_controller or ResultsController()
    ...
    def _year_in_range(
        ...
        """Check if result's year is in range. Delegates to controller."""
    ...
    def _bpm_in_range(
        ...
        """Check if result's BPM is in range. Delegates to controller."""
    ...
    def _filter_results(self) -> List[TrackResult]:
        """Apply filters to results using ResultsController."""
