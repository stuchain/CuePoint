...
class TestBestBeatportMatch:
    ...
    def test_best_beatport_match_finds_match(
        self, mock_parse, mock_track_urls, sample_track
    ):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    def test_best_beatport_match_no_candidates(self, mock_track_urls, sample_track):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_early_exit(self, mock_parse, mock_track_urls):
        ...
        queries = ["Test Track Test Artist", "Test Track", "Test Artist"]
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_title_only_mode(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_with_year(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_with_key(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_with_mix_flags(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_multiple_candidates(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_parse_error(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    def test_best_beatport_match_empty_queries(self, mock_track_urls):
    ...
    def test_best_beatport_match_with_generic_phrases(
        self, mock_parse, mock_track_urls
    ):
    ...
    def test_best_beatport_match_adaptive_max_results(
        ...
        with patch.dict(
            SETTINGS, {"ADAPTIVE_MAX_RESULTS": False, "MAX_SEARCH_RESULTS": 50}
        ):
            queries = ["Test Track Test Artist"]
            best, candidates, queries_audit, last_q = best_beatport_match(
                idx=1,
    ...
    def test_best_beatport_match_token_ratio_guard(self, mock_parse, mock_track_urls):
        ...
        mock_track_urls.return_value = ["https://www.beatport.com/track/sun/123"]
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_high_similarity_penalty(
        self, mock_parse, mock_track_urls
    ):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_guard_token_coverage(
        self, mock_parse, mock_track_urls
    ):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_early_exit_conditions(
        self, mock_parse, mock_track_urls
    ):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_exact_title_wrong_artist(
        self, mock_parse, mock_track_urls
    ):
    ...
    def test_key_bonus_near_keys_csharp_db(self):
        ...
        assert (
            result >= 0
        )  # At least not error, may be 0 or 1 depending on normalization
    ...
    def test_title_mentions_input_remix_empty_token(self):
        ...
        with (
            patch("cuepoint.core.matcher.track_urls") as mock_track_urls,
    ...
    def test_parallel_fetching_timeout(self):
        ...
        try:
            with (
                ...
                with (
                    patch(
                        "cuepoint.core.matcher.ThreadPoolExecutor"
    ...
    def test_candidate_with_none_title(self):
        ...
        with (
            ...
            if candidates:
                ...
                no_title_candidates = [
                    c for c in candidates if c.reject_reason == "no_title"
                ]
    ...
    def test_cached_track_id_reuse(self):
        ...
        with (
            ...
            mock_track_urls.side_effect = [
                ...
                [
                    "https://www.beatport.com/track/test-track-alt/123456"
