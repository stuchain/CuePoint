...
class TestErrorReportingPrefs:
    ...
    def prefs(self, mock_settings):
        ...
        with patch(
            "cuepoint.utils.error_reporting_prefs.QSettings", return_value=mock_settings
        ):
    ...
    def test_is_enabled_default(self, prefs, mock_settings):
        ...
        mock_settings.value.assert_called_with(
            "error_reporting/enabled", True, type=bool
        )
    ...
    def test_has_user_consented_default(self, prefs, mock_settings):
        ...
        mock_settings.value.assert_called_with(
            "error_reporting/consented", False, type=bool
        )
