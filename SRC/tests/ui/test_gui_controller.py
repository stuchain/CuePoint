...
def test_gui_controller(qapp):
    ...
    assert hasattr(window.controller, "progress_updated"), (
        "Progress signal should exist"
    )
    assert hasattr(window.controller, "processing_complete"), (
        "Complete signal should exist"
    )
