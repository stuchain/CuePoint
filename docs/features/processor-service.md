...
> **Status: shared.** The CLI runs this service over a playlist file. Since Phase 7
> the desktop app runs the same `process_track` over library tracks from
> [Clean](../user-guide/clean.md) (`services/match_service.py`, DEC-065); the
> file-based entry points below are the CLI's.
