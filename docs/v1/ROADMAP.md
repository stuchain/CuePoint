...
(ORG-01…ORG-13), unblocked by Decision Round 8 (DEC-057…DEC-064); ORG-01 is implemented and the
other twelve are not.
...
Step specifications: `PHASE6_ORG.md` (ORG-01…ORG-13; ORG-01 implemented).
