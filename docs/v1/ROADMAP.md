...
(ORG-01…ORG-13), unblocked by Decision Round 8 (DEC-057…DEC-064); ORG-01 through ORG-04 are
implemented and the other nine are not.
...
ORG-04 changed that — one method body, no callers moved.

Step specifications: `PHASE6_ORG.md` (ORG-01…ORG-13; ORG-01 through ORG-04 implemented).
