...
class ReportIssueDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.title_input.setPlaceholderText(
            tr("issue.report.title_placeholder", "Brief description of the issue")
        )
        ...
        self.include_bundle_checkbox = QCheckBox(
            tr("issue.report.include_bundle", "Generate and attach support bundle")
        )
        ...
        self.submit_feedback_button = QPushButton(
            tr("feedback.submit", "Submit Feedback")
        )
        ...
        self.report_button = QPushButton(
            tr("issue.report.open_github", "Open GitHub Issue")
        )
...
[Any other relevant information]""",
    ...
    def open_github_issue(self):
        ...
        issue_url = os.environ.get(
            "CUEPOINT_ISSUE_URL", "https://github.com/your-repo/cuepoint/issues/new"
        )

        # Get form data
        issue_type = self.issue_type.currentText()
        title = self.title_input.text() or tr(
            "issue.report.default_title", "Issue Report"
        )
        ...
        if "CuePoint Version:" not in description:
            description = tr(
                ...
                version=version, system=system, release=release, description=description
            )
        ...
        if self.include_bundle_checkbox.isChecked():
            try:
                ...
                description += tr(
                    "issue.report.bundle_error",
                    "\n\n**Note:** Failed to generate support bundle: {error}",
                ).format(error=str(e))
        ...
        if bundle_path:
            ...
            msg.setWindowTitle(
                tr("issue.report.bundle_title", "Support Bundle Generated")
            )
            msg.setText(
                tr(
    ...
    def submit_feedback(self):
        ...
        if not feedback_text:
            QMessageBox.warning(
                self,
                tr("feedback.invalid", "Invalid Feedback"),
        ...
        try:
            ...
            if issue_number:
                QMessageBox.information(
                    ...
                    tr(
                        "feedback.thank_you",
                        "Thank you for your feedback! It has been submitted as issue #{issue_number}.",
            ...
            QMessageBox.critical(
                ...
                tr(
                    ...
                    "An error occurred while submitting feedback: {error}",
                ).format(error=str(e)),
            )
        finally:
