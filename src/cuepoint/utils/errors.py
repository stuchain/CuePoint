...
def format_error_message(
    ...
    Example:
        ...
        ...     suggestions=["Check file path", "Create config/config.yaml.template"],
...
def error_file_not_found(
    file_path: str, file_type: str = "file", suggestion_base: Optional[str] = None
) -> str:
    """
...
def error_playlist_not_found(playlist_name: str, available_playlists: List[str]) -> str:
    """
...
def error_network(url: str, error: Exception, error_type: str = "Network Error") -> str:
    """
    ...
    context = {"URL": url, "Error": error_msg}
