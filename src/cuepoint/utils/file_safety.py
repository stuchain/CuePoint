...
class SafeFileWriter:
    ...
    def write_text_atomic(
        file_path: Path, text: str, encoding: str = "utf-8", backup: bool = False
    ) -> bool:
...
class BackupManager:
    ...
    @staticmethod
    def _cleanup_old_backups(file_path: Path, backup_dir: Path, max_backups: int):
    ...
    @staticmethod
    def restore_backup(
        backup_path: Path, target_path: Path, create_backup: bool = True
    ) -> bool:
