...
class TestMatcherExtended:
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_multiple_queries(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_duplicate_urls(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_with_year_bonus(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_with_key_bonus(self, mock_parse, mock_track_urls):
    ...
    @patch("cuepoint.core.matcher.track_urls")
    @patch("cuepoint.core.matcher.parse_track_page")
    def test_best_beatport_match_parse_returns_none(self, mock_parse, mock_track_urls):
