...
class TestScoreComponents:
    ...
    def test_score_components_exact_match(self):
        ...
        t_sim, a_sim, comp = score_components(
            "Test Track", "Test Artist", "Test Track", "Test Artist"
        )
    ...
    def test_score_components_partial_match(self):
        ...
        t_sim, a_sim, comp = score_components(
            "Test Track", "Test Artist", "Test", "Artist"
        )
        assert t_sim > 0
        assert a_sim > 0
        assert comp > 0
    ...
    def test_score_components_empty_artists(self):
        ...
        t_sim, a_sim, comp = score_components("Test Track", "", "Test Track", "")
        assert t_sim > 0
...
class TestArtistsSimilarity:
    ...
    def test_artists_similarity_no_match(self):
        ...
        score = artists_similarity(
            "Completely Different Artist", "Totally Unrelated Performer"
        )
        assert score < 50
    ...
    def test_artist_token_overlap(self):
        ...
        assert (
            _artist_token_overlap("Completely Different", "Totally Unrelated") is False
        )
...
class TestWordTokens:
    ...
    def test_score_components_with_accents(self):
        ...
        t_sim, a_sim, comp = score_components(
            "Café Track", "José Artist", "Cafe Track", "Jose Artist"
        )
    ...
    def test_score_components_different_order(self):
        ...
        t_sim, a_sim, comp = score_components(
            "Never Sleep Again", "Tim Green", "Sleep Never Again", "Green Tim"
        )
