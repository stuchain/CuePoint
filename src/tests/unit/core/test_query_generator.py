...
class TestMakeSearchQueries:
    ...
    def test_make_search_queries_basic(self):
        ...
        queries = make_search_queries(title="Test Track", artists="Test Artist")
    ...
    def test_make_search_queries_title_only(self):
        ...
        queries = make_search_queries(title="Test Track", artists="")
        assert len(queries) > 0
        assert any("Test Track" in q for q in queries)
    ...
    def test_make_search_queries_with_remix(self):
        ...
        assert any("remix" in q.lower() for q in queries) or any(
            "Remixer" in q for q in queries
        )
    ...
    def test_query_normalization_variants(self) -> None:
        ...
        assert any("Track Name" in q for q in queries) or any(
            "Track" in q for q in queries
        )

    def test_make_search_queries_empty_title(self):
        """Test query generation with empty title."""
        queries = make_search_queries(title="", artists="Test Artist")
    ...
    def test_make_search_queries_with_original_mix(self):
        ...
        assert any("original" in q.lower() for q in queries) or any(
            "Test Track" in q for q in queries
        )
    ...
    def test_make_search_queries_with_extended_mix(self):
        ...
        assert any("extended" in q.lower() for q in queries) or any(
            "Test Track" in q for q in queries
        )
    ...
    def test_make_search_queries_multiple_artists(self):
        ...
        queries = make_search_queries(title="Test Track", artists="Artist A, Artist B")
        assert len(queries) > 0
    ...
    def test_make_search_queries_artist_extraction_from_title(self):
        ...
        queries = make_search_queries(
            title="Test Track", artists="", original_title="Artist Name - Test Track"
        )
    ...
    def test_make_search_queries_reverse_order(self):
        ...
        title_artist_queries = [
            q for q in queries if "Test Track" in q and "Test Artist" in q
        ]
        assert len(title_artist_queries) > 0

    def test_make_search_queries_title_ngrams(self):
        """Test that title N-grams are generated."""
        queries = make_search_queries(title="Never Sleep Again", artists="Test Artist")
    ...
    def test_make_search_queries_filters_stop_words(self):
        ...
        queries = make_search_queries(title="The Test Track", artists="Test Artist")
    ...
    def test_make_search_queries_handles_prefixes(self):
        ...
        queries = make_search_queries(
            title="Test Track", artists="Test Artist", original_title="[F] Test Track"
        )
        ...
        queries_without_prefix = [
            q for q in queries if "[F]" not in q and "[f]" not in q
        ]
    ...
    def test_make_search_queries_extract_artists_exception(self):
        ...
        with patch(
            "cuepoint.core.query_generator.extract_artists_from_title"
        ) as mock_extract:
            mock_extract.side_effect = Exception("Test exception")

            # Should handle exception gracefully
            queries = make_search_queries(
                title="Test Track", artists="", original_title="Artist - Test Track"
            )
...
class TestMakeSearchQueriesSettings:
    ...
    def test_make_search_queries_reverse_order_settings(self):
        ...
        with patch.dict(
            SETTINGS, {"REVERSE_ORDER_QUERIES": True, "PRIORITY_REVERSE_STAGE": True}
        ):
            queries = make_search_queries(title="Test Track", artists="Test Artist")
    ...
    def test_make_search_queries_cross_grams_settings(self):
        ...
        with patch.dict(
            ...
            queries = make_search_queries(
                title="Test Track Title", artists="Test Artist"
            )
    ...
    def test_make_search_queries_long_title(self):
        ...
        queries = make_search_queries(title=long_title, artists="Test Artist")
