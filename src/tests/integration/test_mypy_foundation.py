...
GUARDED = (
    ...
    "cuepoint/models/track_metadata.py",
    "cuepoint/models/row_values.py",
    "cuepoint/models/match_attempt.py",
    "cuepoint/models/file_status.py",
    "cuepoint/models/duplicate_group.py",
    ...
    "cuepoint/services/match_input.py",
    ...
    "cuepoint/services/file_check_service.py",
    "cuepoint/services/busy_wait.py",
    "cuepoint/services/duplicate_keys.py",
    "cuepoint/services/duplicate_service.py",
    "cuepoint/services/artwork_cache.py",
    "cuepoint/services/artwork_service.py",
    "cuepoint/data/artwork.py",
    "cuepoint/data/artwork_image.py",
    "cuepoint/data/tag_fields.py",
    "cuepoint/services/tag_write_options.py",
    ...
    "cuepoint/models/rekordbox_export_values.py",
    "cuepoint/models/track_credit.py",
    "cuepoint/models/beatport_cache.py",
    "cuepoint/models/discovery_run.py",
    "cuepoint/models/wantlist.py",
    "cuepoint/models/filter_rule.py",
    "cuepoint/core/entity_names.py",
    "cuepoint/services/credit_index_service.py",
    "cuepoint/engine/credit_index_jobs.py",
