...
class TestConfigServiceIntegration:
    ...
    def test_config_from_file(self):
        ...
        config_data = {"beatport": {"timeout": 45}, "processing": {"max_concurrent": 5}}
    ...
    def test_config_load_from_nonexistent_file(self):
        ...
        nonexistent_file = (
            Path(tempfile.gettempdir()) / "cuepoint_test_nonexistent" / "config.yaml"
        )
    ...
    def test_config_multiple_sources_file_and_env(self, monkeypatch):
        ...
        # Create config file
        config_data = {"beatport": {"timeout": 45}}
    ...
    def test_config_validate_out_of_range_values(self, config_service):
        ...
        config_service.set(
            "matching.min_accept_score", 300.0
        )  # Invalid (should be <= 200.0)
