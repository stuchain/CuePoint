...
class TestFeedbackSubmission:
    ...
    def test_submit_feedback_empty(self, dialog):
        ...
        with patch("PySide6.QtWidgets.QMessageBox.warning") as mock_warning:
            ...
            assert (
                "enter your feedback" in mock_warning.call_args[0][2].lower()
                or "please enter" in mock_warning.call_args[0][2].lower()
            )
    ...
    def test_submit_feedback_too_short(self, dialog):
        ...
        with patch("PySide6.QtWidgets.QMessageBox.warning") as mock_warning:
            ...
            mock_warning.assert_called_once()
            assert (
                "more details" in mock_warning.call_args[0][2].lower()
                or "at least" in mock_warning.call_args[0][2].lower()
            )
    ...
    def test_submit_feedback_success(self, mock_report_error, dialog):
        ...
        dialog.description_input.setPlainText(
            "This is a test feedback message with enough characters."
        )
        ...
        with patch("PySide6.QtWidgets.QMessageBox.information") as mock_info:
            ...
            assert (
                call_kwargs["additional_info"]["feedback_category"] == "Feature Request"
            )

            # Verify success message
            mock_info.assert_called_once()
            assert (
                "123" in mock_info.call_args[0][2]
                or "submitted" in mock_info.call_args[0][2].lower()
            )
    ...
    def test_submit_feedback_failure(self, mock_report_error, dialog):
        ...
        with patch("PySide6.QtWidgets.QMessageBox.warning") as mock_warning:
            ...
            mock_warning.assert_called_once()
            assert (
                "could not submit" in mock_warning.call_args[0][2].lower()
                or "failed" in mock_warning.call_args[0][2].lower()
            )
