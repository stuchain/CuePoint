...
def test_xml_parsing():
    """Test XML parsing"""
    tracks, playlists = parse_rekordbox("tests/fixtures/sample_collection.xml")
    assert len(tracks) > 0
...
def test_end_to_end_processing():
    ...
    run(
        xml_path="tests/fixtures/sample_collection.xml",
...
**Location**: `tests/mocks/mock_beatport.py`
...
**Location**: `tests/fixtures/sample_collection.xml`
...
**HTML Response**: `tests/fixtures/sample_beatport_response.html`
**JSON Response**: `tests/fixtures/sample_beatport_response.json`
...
# Run specific test
pytest tests/unit/test_matcher.py::test_scoring_logic
