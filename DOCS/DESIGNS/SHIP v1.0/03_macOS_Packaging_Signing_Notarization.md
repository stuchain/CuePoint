## 3. macOS Packaging, Signing & Notarization (Ship v1.0)
...
### 3.3.1 Hardened runtime & entitlements
...
### 3.4.1 Concrete signing recipe (CI-friendly)
...
### 3.5.1 Notarization troubleshooting checklist
