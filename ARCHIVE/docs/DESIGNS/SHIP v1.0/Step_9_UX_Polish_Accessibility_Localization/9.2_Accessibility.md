...
2. `SRC/tests/ui/test_keyboard_navigation.py` - Keyboard navigation tests (new)
3. `SRC/tests/ui/test_screen_reader.py` - Screen reader tests (new)
4. `SRC/tests/ui/test_contrast.py` - Contrast validation tests (new)
