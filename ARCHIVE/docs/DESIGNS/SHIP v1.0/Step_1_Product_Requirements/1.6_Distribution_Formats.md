...
- **File to Create**: `SRC/tests/acceptance/fixtures/clean_vm.py`
- **Implementation**:
  ```python
...
5. `SRC/tests/acceptance/test_installation.py` - Installation tests
6. `SRC/tests/acceptance/fixtures/clean_vm.py` - Test fixtures
...
- **Clean VM Test Setup**:
  ```python
  # SRC/tests/acceptance/fixtures/clean_vm.py
  """Test fixtures for clean VM testing"""
  import subprocess
  import platform
  from pathlib import Path
