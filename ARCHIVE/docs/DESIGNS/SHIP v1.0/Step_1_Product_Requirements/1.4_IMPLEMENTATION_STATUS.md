...
| Installation Testing | ❌ Deferred to Step 7 | `SRC/tests/acceptance/test_installation.py` |
...
| Trust Verification Tests | ❌ Deferred to Step 7 | `SRC/tests/acceptance/test_trust.py` |
