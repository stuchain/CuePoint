...
pytest ARCHIVE/tests/update_installer/tests/test_installed_version.py -v

# Or use the helper script
python ARCHIVE/tests/update_installer/tests/run_installed_tests.py

# Run specific test
pytest ARCHIVE/tests/update_installer/tests/test_installed_version.py::TestInstalledVersion::test_executable_exists -v

# Run only fast tests (skip slow ones)
pytest ARCHIVE/tests/update_installer/tests/test_installed_version.py -v -m "not slow"
```
...
- name: Test installed version
  run: pytest ARCHIVE/tests/update_installer/tests/test_installed_version.py -v
```
